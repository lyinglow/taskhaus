...
export default function AdminDashboard({ onNavigate }) {
  ...
  const runPasswordResetMigration = async () => {
    ...
    try {
      const res = await api.post('/admin/migrate-password-reset-columns');
  ...
  return (
    <div className="container max-w-6xl py-10 mx-auto px-4">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-8">
        <p className="text-sm text-stone-700 mb-2">One-time setup: adds password-reset columns to customer accounts.</p>
        <button
