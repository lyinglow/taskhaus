  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 bg-white p-8 sm:p-10 rounded-lg shadow-lg w-full max-w-md">
        <h2 className="text-2xl font-bold text-stone-900 mb-2">Reset your password</h2>
        <p className="text-stone-600 mb-8">Enter your email and we'll send you a link to reset your password.</p>

        {message ? (
          <div className="bg-brand-50 text-brand-800 p-4 rounded-lg text-sm mb-6">{message}</div>
        ) : (
