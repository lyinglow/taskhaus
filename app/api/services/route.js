...
export async function POST(req) {
  try {
    ...
    const { name, description, longDescription, toolsNeeded, estimatedDuration, serviceType, category, price, requiresPhotoReview, partnerCredit, season } = await req.json();
